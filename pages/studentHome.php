...
<head>
  ...
  <link href="/css/styleStudent.css" rel="stylesheet">
</head>
...
-->
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Bem vindo a comunidade <span>Praise Lab</span></h2>
          <p class="animate__animated animate__fadeInUp">Aqui, além de aprender um instrumento, ensinamos você a tocar em publico!</p>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Professores Apaixonados por musica</h2>
          <p class="animate__animated animate__fadeInUp">Contamos com professores, que possuem paixão por enssinar e por música!</p>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Repertórios</h2>
          <p class="animate__animated animate__fadeInUp">Você aprenderá a montar repertórios para diferentes momentos!</p>
        </div>
      </div>
  ...
  <main id="main">
    ...
    <!-- ======= Icon Boxes Section ======= -->
    <section id="icon-boxes" class="icon-boxes pt-5">
      <div class="container">
  ...
  <script src="/libs/php-email-form/validate.js"></script>
